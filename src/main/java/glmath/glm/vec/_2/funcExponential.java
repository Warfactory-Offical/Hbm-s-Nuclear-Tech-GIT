...
abstract class funcExponential extends funcCommon {
    ...
    public Vec2 exp(final Vec2 result) {
        return exp((Vec2) this, result);
    }

    public static Vec2 exp(final Vec2 x, final Vec2 result) {
    ...
    public Vec2 exp2(final Vec2 result) {
        return exp2((Vec2) this, result);
    }

    public static Vec2 exp2(final Vec2 x, final Vec2 result) {
    ...
    public Vec2 inverseSqrt(final Vec2 result) {
        return inverseSqrt((Vec2) this, result);
    }

    public static Vec2 inverseSqrt(final Vec2 x, final Vec2 result) {
    ...
    public Vec2 log(final Vec2 result) {
        return log((Vec2) this, result);
    }

    public static Vec2 log(final Vec2 x, final Vec2 result) {
    ...
    public Vec2 log2(final Vec2 result) {
        return log2((Vec2) this, result);
    }

    public static Vec2 log2(final Vec2 x, final Vec2 result) {
        result.x = (float) (Math.log(x.x) / Math.log(2));
        result.y = (float) (Math.log(x.y) / Math.log(2));
        return result;
    }

    public Vec2 pow(final Vec2 y) {
        return pow(y, (Vec2) this);
    }

    public Vec2 pow_(final Vec2 y) {
        return pow(y, new Vec2());
    }

    public Vec2 pow(final Vec2 y, final Vec2 result) {
        return pow((Vec2) this, y, result);
    }

    public static Vec2 pow(final Vec2 x, final Vec2 y, final Vec2 result) {
    ...
    public Vec2 sqrt(final Vec2 result) {
        return sqrt((Vec2) this, result);
    }

    public static Vec2 sqrt(final Vec2 x, final Vec2 result) {
