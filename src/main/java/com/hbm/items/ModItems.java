...
import api.hbm.material.MaterialShapes;
import api.hbm.material.Mats;
...
import static api.hbm.material.Mats.*;
...
public class ModItems {
	...
	public static final ItemStack ingot_am_mix = new ItemStack(new ItemHazard("ingot_am_mix").addRadiation(ItemHazard.amrg * ItemHazard.ingot).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_am241 = new ItemStack(new ItemHazard("ingot_am241").addRadiation(ItemHazard.am241 * ItemHazard.ingot).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_am242 = new ItemStack(new ItemHazard("ingot_am242").addRadiation(ItemHazard.am242 * ItemHazard.ingot).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_americium_fuel = new ItemStack(new ItemHazard(ItemHazard.amf, "ingot_americium_fuel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_arsenic = new ItemStack(new ItemHazard("ingot_arsenic").addToxic(16).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_asbestos = new ItemStack(new ItemHazard("ingot_asbestos").addAsbestos(6).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_astatine = new ItemStack(new ItemCustomLore("ingot_astatine").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_au198 = new ItemStack(new ItemHazard("ingot_au198").addRadiation(ItemHazard.au198 * ItemHazard.ingot).addFire(15).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_australium = new ItemStack(new ItemCustomLore("ingot_australium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_bakelite = new ItemStack(new ItemCustomLore("ingot_bakelite").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_beryllium = new ItemStack(new ItemBase("ingot_beryllium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_biorubber = new ItemStack(new ItemCustomLore("ingot_biorubber").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_bismuth = new ItemStack(new ItemCustomLore("ingot_bismuth").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_boron = new ItemStack(new ItemBase("ingot_boron").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_bromine = new ItemStack(new ItemCustomLore("ingot_bromine").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_cadmium = new ItemStack(new ItemBase("ingot_cadmium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_caesium = new ItemStack(new ItemHazard(0.0F, true, "ingot_caesium").addHydroReactivity().toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_cdalloy = new ItemStack(new ItemBase("ingot_cdalloy").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_cerium = new ItemStack(new ItemCustomLore("ingot_cerium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_chainsteel = new ItemStack(new ItemHot(100, "ingot_chainsteel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_co60 = new ItemStack(new ItemHazard(ItemHazard.co60, "ingot_co60").addFire(5).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_cobalt = new ItemStack(new ItemCustomLore("ingot_cobalt").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_combine_steel = new ItemStack(new ItemCustomLore("ingot_combine_steel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_copper = new ItemStack(new ItemBase("ingot_copper").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_daffergon = new ItemStack(new ItemCustomLore("ingot_daffergon").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_desh = new ItemStack(new ItemCustomLore("ingot_desh").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_dineutronium = new ItemStack(new ItemCustomLore("ingot_dineutronium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_dura_steel = new ItemStack(new ItemCustomLore("ingot_dura_steel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_electronium = new ItemStack(new ItemUnstable(30, 6000, "ingot_electronium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_euphemium = new ItemStack(new ItemCustomLore("ingot_euphemium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_ferrouranium = new ItemStack(new ItemHazard("ingot_ferrouranium").addRadiation(ItemHazard.u * 0.5F).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_fiberglass = new ItemStack(new ItemCustomLore("ingot_fiberglass").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_firebrick = new ItemStack(new ItemBase("ingot_firebrick").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_gh336 = new ItemStack(new ItemHazard(ItemHazard.gh336, "ingot_gh336").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_graphite = new ItemStack(new ItemFuel("ingot_graphite", 1600).setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_hes = new ItemStack(new ItemHazard(ItemHazard.hes, false, true, "ingot_hes").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_i131 = new ItemStack(new ItemHazard(ItemHazard.i131, "ingot_i131").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_iodine = new ItemStack(new ItemCustomLore("ingot_iodine").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_lanthanium = new ItemStack(new ItemCustomLore("ingot_lanthanium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_lead = new ItemStack(new ItemHazard("ingot_lead").addToxic(2).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_les = new ItemStack(new ItemHazard(ItemHazard.les, false, true, "ingot_les").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_magnetized_tungsten = new ItemStack(new ItemHazard(ItemHazard.magt, "ingot_magnetized_tungsten").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_meteorite = new ItemStack(new ItemHot(200, "ingot_meteorite").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_meteorite_forged = new ItemStack(new ItemHot(200, "ingot_meteorite_forged").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_mox_fuel = new ItemStack(new ItemHazard(ItemHazard.mox, "ingot_mox_fuel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_neodymium = new ItemStack(new ItemCustomLore("ingot_neodymium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_neptunium = new ItemStack(new ItemHazard(ItemHazard.np237, true, "ingot_neptunium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_neptunium_fuel = new ItemStack(new ItemHazard(ItemHazard.npf, true, "ingot_neptunium_fuel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_niobium = new ItemStack(new ItemCustomLore("ingot_niobium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_osmiridium = new ItemStack(new ItemHazard("ingot_osmiridium").addDigamma(0.040F).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_pb209 = new ItemStack(new ItemHazard(ItemHazard.pb209, true, true, "ingot_pb209").addToxic(2).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_phosphorus = new ItemStack(new ItemHazard(0F, true, "ingot_phosphorus").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_plutonium = new ItemStack(new ItemHazard(ItemHazard.pu, "ingot_plutonium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_plutonium_fuel = new ItemStack(new ItemHazard(ItemHazard.puf, "ingot_plutonium_fuel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_polonium = new ItemStack(new ItemHazard(ItemHazard.po210, true, "ingot_polonium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_polymer = new ItemStack(new ItemCustomLore("ingot_polymer").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_pu_mix = new ItemStack(new ItemHazard(ItemHazard.purg * ItemHazard.ingot, "ingot_pu_mix").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_pu238 = new ItemStack(new ItemHazard(ItemHazard.pu238, true, false, "ingot_pu238").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_pu239 = new ItemStack(new ItemHazard(ItemHazard.pu239, "ingot_pu239").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_pu240 = new ItemStack(new ItemHazard(ItemHazard.pu240, "ingot_pu240").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_pu241 = new ItemStack(new ItemHazard("ingot_pu241").addRadiation(ItemHazard.pu241 * ItemHazard.ingot).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_ra226 = new ItemStack(new ItemHazard(ItemHazard.ra226, "ingot_ra226").addHydroReactivity().toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_radspice = new ItemStack(new ItemHazard(ItemHazard.radspice, "ingot_radspice").addFire(15).addToxic(2).addBlinding().addHydroReactivity().toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_red_copper = new ItemStack(new ItemBase("ingot_red_copper").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_reiium = new ItemStack(new ItemCustomLore("ingot_reiium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_rubber = new ItemStack(new ItemCustomLore("ingot_rubber").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_saturnite = new ItemStack(new ItemCustomLore("ingot_saturnite").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_schrabidate = new ItemStack(new ItemHazard(ItemHazard.sb, false, true, "ingot_schrabidate").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_schrabidium = new ItemStack(new ItemHazard(ItemHazard.sa326, false, true, "ingot_schrabidium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_schrabidium_fuel = new ItemStack(new ItemHazard(ItemHazard.saf, false, true, "ingot_schrabidium_fuel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_schraranium = new ItemStack(new ItemHazard(ItemHazard.sr, false, true, "ingot_schraranium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_smore = new ItemStack(new ItemFoodBase(10, 20F, false, "ingot_smore").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_solinium = new ItemStack(new ItemHazard(ItemHazard.sa327, false, true, "ingot_solinium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_sr90 = new ItemStack(new ItemHazard(ItemHazard.sr90, true, "ingot_sr90").addHydroReactivity().toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_starmetal = new ItemStack(new ItemCustomLore("ingot_starmetal").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_steel = new ItemStack(new ItemBase("ingot_steel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_steel_dusted = new ItemStack(new ItemHotDusted(200, "ingot_steel_dusted").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_strontium = new ItemStack(new ItemHazard("ingot_strontium").addHydroReactivity().toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_tantalium = new ItemStack(new ItemCustomLore("ingot_tantalium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_tcalloy = new ItemStack(new ItemHazard(0.07F, "ingot_tcalloy").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_technetium = new ItemStack(new ItemHazard("ingot_technetium").addRadiation(ItemHazard.tc99 * ItemHazard.ingot).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_tennessine = new ItemStack(new ItemHazard(120F, "ingot_tennessine").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_th232 = new ItemStack(new ItemHazard(ItemHazard.th232, "ingot_th232").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_thorium_fuel = new ItemStack(new ItemHazard(ItemHazard.thf, "ingot_thorium_fuel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_titanium = new ItemStack(new ItemBase("ingot_titanium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_tungsten = new ItemStack(new ItemBase("ingot_tungsten").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_u233 = new ItemStack(new ItemHazard(ItemHazard.u233, "ingot_u233").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_u235 = new ItemStack(new ItemHazard(ItemHazard.u235, "ingot_u235").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_u238 = new ItemStack(new ItemHazard(ItemHazard.u238, "ingot_u238").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_u238m2 = new ItemStack(new ItemUnstable(350, 200, "ingot_u238m2").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_unobtainium = new ItemStack(new ItemCustomLore("ingot_unobtainium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_uranium = new ItemStack(new ItemHazard(ItemHazard.u, "ingot_uranium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_uranium_fuel = new ItemStack(new ItemHazard(ItemHazard.uf, "ingot_uranium_fuel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_verticium = new ItemStack(new ItemCustomLore("ingot_verticium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_weidanium = new ItemStack(new ItemCustomLore("ingot_weidanium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack ingot_zirconium = new ItemStack(new ItemBase("ingot_zirconium").setCreativeTab(MainRegistry.partsTab));

	public static final ItemStack billet_ac227 = new ItemStack(new ItemHazard(ItemHazard.ac227 * ItemHazard.billet, "billet_ac227").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_am_mix = new ItemStack(new ItemHazard(ItemHazard.amrg * ItemHazard.billet, "billet_am_mix").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_am241 = new ItemStack(new ItemHazard(ItemHazard.am241 * ItemHazard.billet, "billet_am241").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_am242 = new ItemStack(new ItemHazard(ItemHazard.am242 * ItemHazard.billet, "billet_am242").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_americium_fuel = new ItemStack(new ItemHazard(ItemHazard.amf * ItemHazard.billet, "billet_americium_fuel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_au198 = new ItemStack(new ItemHazard(ItemHazard.au198 * ItemHazard.billet, "billet_au198").addFire(15).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_australium = new ItemStack(new ItemCustomLore("billet_australium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_australium_greater = new ItemStack(new ItemCustomLore("billet_australium_greater").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_australium_lesser = new ItemStack(new ItemCustomLore("billet_australium_lesser").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_balefire_gold = new ItemStack(new ItemHazard(ItemHazard.au198 * ItemHazard.billet, true, "billet_balefire_gold").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_beryllium = new ItemStack(new ItemBase("billet_beryllium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_bismuth = new ItemStack(new ItemBase("billet_bismuth").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_co60 = new ItemStack(new ItemHazard(ItemHazard.co60 * ItemHazard.billet, "billet_co60").addFire(5).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_flashlead = new ItemStack(new ItemHazard(ItemHazard.aupb * ItemHazard.billet, true, true, "billet_flashlead").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_gh336 = new ItemStack(new ItemHazard(ItemHazard.gh336 * ItemHazard.billet, "billet_gh336").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_hes = new ItemStack(new ItemHazard(ItemHazard.hes * ItemHazard.billet, "billet_hes").addBlinding().toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_les = new ItemStack(new ItemHazard(ItemHazard.les * ItemHazard.billet, "billet_les").addBlinding().toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_mox_fuel = new ItemStack(new ItemHazard(ItemHazard.mox * ItemHazard.billet, "billet_mox_fuel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_neptunium = new ItemStack(new ItemHazard(ItemHazard.np237 * ItemHazard.billet, true, "billet_neptunium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_neptunium_fuel = new ItemStack(new ItemHazard(ItemHazard.npf * ItemHazard.billet, true, "billet_neptunium_fuel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_nuclear_waste = new ItemStack(new ItemContaminating(ItemHazard.wst * ItemHazard.billet, "billet_nuclear_waste").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_pb209 = new ItemStack(new ItemHazard(ItemHazard.pb209 * ItemHazard.billet, true, true, "billet_pb209").addToxic(2).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_plutonium = new ItemStack(new ItemHazard(ItemHazard.pu * ItemHazard.billet, "billet_plutonium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_plutonium_fuel = new ItemStack(new ItemHazard(ItemHazard.puf * ItemHazard.billet, "billet_plutonium_fuel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_po210be = new ItemStack(new ItemHazard(ItemHazard.pobe, "billet_po210be").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_polonium = new ItemStack(new ItemHazard(ItemHazard.po210 * ItemHazard.billet, true, "billet_polonium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_pu_mix = new ItemStack(new ItemHazard(ItemHazard.purg * ItemHazard.billet, "billet_pu_mix").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_pu238 = new ItemStack(new ItemHazard(ItemHazard.pu238 * ItemHazard.billet, true, "billet_pu238").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_pu238be = new ItemStack(new ItemHazard(ItemHazard.pube, "billet_pu238be").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_pu239 = new ItemStack(new ItemHazard(ItemHazard.pu239 * ItemHazard.billet, "billet_pu239").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_pu240 = new ItemStack(new ItemHazard(ItemHazard.pu240 * ItemHazard.billet, "billet_pu240").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_pu241 = new ItemStack(new ItemHazard(ItemHazard.pu241 * ItemHazard.billet, "billet_pu241").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_ra226 = new ItemStack(new ItemHazard(ItemHazard.ra226 * ItemHazard.billet, "billet_ra226").addHydroReactivity().toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_ra226be = new ItemStack(new ItemHazard(ItemHazard.rabe, "billet_ra226be").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_schrabidium = new ItemStack(new ItemHazard(ItemHazard.sa326 * ItemHazard.billet, false, true, "billet_schrabidium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_schrabidium_fuel = new ItemStack(new ItemHazard(ItemHazard.saf * ItemHazard.billet, false, true, "billet_schrabidium_fuel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_solinium = new ItemStack(new ItemHazard(ItemHazard.sa327 * ItemHazard.billet, false, true, "billet_solinium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_sr90 = new ItemStack(new ItemHazard(ItemHazard.sr90 * ItemHazard.billet, "billet_sr90").addHydroReactivity().addFire(5).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_technetium = new ItemStack(new ItemHazard(ItemHazard.tc99 * ItemHazard.billet, "billet_technetium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_th232 = new ItemStack(new ItemHazard(ItemHazard.th232 * ItemHazard.billet, "billet_th232").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_thorium_fuel = new ItemStack(new ItemHazard(ItemHazard.thf * ItemHazard.billet, "billet_thorium_fuel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_u233 = new ItemStack(new ItemHazard(ItemHazard.u233 * ItemHazard.billet, "billet_u233").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_u235 = new ItemStack(new ItemHazard(ItemHazard.u235 * ItemHazard.billet, "billet_u235").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_u238 = new ItemStack(new ItemHazard(ItemHazard.u238 * ItemHazard.billet, "billet_u238").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_unobtainium = new ItemStack(new ItemHazard(ItemHazard.unof * ItemHazard.billet, "billet_unobtainium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_uranium = new ItemStack(new ItemHazard(ItemHazard.u * ItemHazard.billet, "billet_uranium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_uranium_fuel = new ItemStack(new ItemHazard(ItemHazard.uf * ItemHazard.billet, "billet_uranium_fuel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_yharonite = new ItemStack(new ItemBase("billet_yharonite").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_zfb_am_mix = new ItemStack(new ItemHazard(ItemHazard.zfb_am_mix * ItemHazard.billet, "billet_zfb_am_mix").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack billet_zfb_bismuth = new ItemStack(new ItemHazard(ItemHazard.zfb_bi * ItemHazard.billet, "billet_zfb_bismuth").setCreativeTab(MainRegistry.partsTab));
	...
	public static final ItemStack nugget_am241 = new ItemStack(new ItemHazard(ItemHazard.am241 * ItemHazard.nugget, "nugget_am241").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_am242 = new ItemStack(new ItemHazard(ItemHazard.am242 * ItemHazard.nugget, "nugget_am242").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_americium_fuel = new ItemStack(new ItemHazard(ItemHazard.amf * ItemHazard.nugget, "nugget_americium_fuel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_arsenic = new ItemStack(new ItemHazard("nugget_arsenic").addToxic(3).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_au198 = new ItemStack(new ItemHazard(ItemHazard.au198 * ItemHazard.nugget, "nugget_au198").addFire(15).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_australium = new ItemStack(new ItemCustomLore("nugget_australium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_australium_greater = new ItemStack(new ItemCustomLore("nugget_australium_greater").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_australium_lesser = new ItemStack(new ItemCustomLore("nugget_australium_lesser").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_beryllium = new ItemStack(new ItemBase("nugget_beryllium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_bismuth = new ItemStack(new ItemBase("nugget_bismuth").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_cadmium = new ItemStack(new ItemBase("nugget_cadmium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_co60 = new ItemStack(new ItemHazard("nugget_co60").addRadiation(ItemHazard.co60 * ItemHazard.nugget).addFire(5).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_cobalt = new ItemStack(new ItemCustomLore("nugget_cobalt").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_daffergon = new ItemStack(new ItemCustomLore("nugget_daffergon").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_desh = new ItemStack(new ItemCustomLore("nugget_desh").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_dineutronium = new ItemStack(new ItemCustomLore("nugget_dineutronium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_euphemium = new ItemStack(new ItemCustomLore("nugget_euphemium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_gh336 = new ItemStack(new ItemHazard(ItemHazard.gh336 * ItemHazard.nugget, "nugget_gh336").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_hes = new ItemStack(new ItemHazard(ItemHazard.hes * ItemHazard.nugget, false, true, "nugget_hes").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_lead = new ItemStack(new ItemHazard("nugget_lead").addToxic(1).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_les = new ItemStack(new ItemHazard(ItemHazard.les * ItemHazard.nugget, false, true, "nugget_les").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_mox_fuel = new ItemStack(new ItemHazard(ItemHazard.mox * ItemHazard.nugget, "nugget_mox_fuel").setCreativeTab(MainRegistry.partsTab).setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_neptunium = new ItemStack(new ItemHazard(ItemHazard.np237 * ItemHazard.nugget, true, "nugget_neptunium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_neptunium_fuel = new ItemStack(new ItemHazard(ItemHazard.npf * ItemHazard.nugget, true, "nugget_neptunium_fuel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_osmiridium = new ItemStack(new ItemHazard("nugget_osmiridium").addDigamma(0.004F).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_pb209 = new ItemStack(new ItemHazard(ItemHazard.pb209 * ItemHazard.nugget, true, true, "nugget_pb209").addToxic(1).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_plutonium = new ItemStack(new ItemHazard(ItemHazard.pu * ItemHazard.nugget, "nugget_plutonium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_plutonium_fuel = new ItemStack(new ItemHazard(ItemHazard.puf * ItemHazard.nugget, "nugget_plutonium_fuel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_polonium = new ItemStack(new ItemHazard(ItemHazard.po210 * ItemHazard.nugget, true, "nugget_polonium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_pu_mix = new ItemStack(new ItemHazard(ItemHazard.purg * ItemHazard.nugget, "nugget_pu_mix").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_pu238 = new ItemStack(new ItemHazard(ItemHazard.pu238 * ItemHazard.nugget, true, "nugget_pu238").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_pu239 = new ItemStack(new ItemHazard(ItemHazard.pu239 * ItemHazard.nugget, "nugget_pu239").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_pu240 = new ItemStack(new ItemHazard(ItemHazard.pu240 * ItemHazard.nugget, "nugget_pu240").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_pu241 = new ItemStack(new ItemHazard(ItemHazard.pu241 * ItemHazard.nugget, "nugget_pu241").addFire(1).toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_ra226 = new ItemStack(new ItemHazard(ItemHazard.ra226 * ItemHazard.nugget, "nugget_ra226").addHydroReactivity().toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_radspice = new ItemStack(new ItemHazard(ItemHazard.radspice * ItemHazard.nugget, "nugget_radspice").addFire(15).addToxic(1).addBlinding().addHydroReactivity().toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_reiium = new ItemStack(new ItemCustomLore("nugget_reiium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_schrabidium = new ItemStack(new ItemHazard(ItemHazard.sa326 * ItemHazard.nugget, false, true, "nugget_schrabidium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_schrabidium_fuel = new ItemStack(new ItemHazard(ItemHazard.saf * ItemHazard.nugget, "nugget_schrabidium_fuel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_solinium = new ItemStack(new ItemHazard(ItemHazard.sa327 * ItemHazard.nugget, false, true, "nugget_solinium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_sr90 = new ItemStack(new ItemHazard(ItemHazard.sr90 * ItemHazard.nugget, true, "nugget_sr90").addHydroReactivity().toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_strontium = new ItemStack(new ItemHazard("nugget_strontium").addHydroReactivity().toItem().setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_tantalium = new ItemStack(new ItemCustomLore("nugget_tantalium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_technetium = new ItemStack(new ItemHazard(ItemHazard.tc99 * ItemHazard.nugget, "nugget_technetium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_th232 = new ItemStack(new ItemHazard(ItemHazard.th232 * ItemHazard.nugget, "nugget_th232").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_thorium_fuel = new ItemStack(new ItemHazard(ItemHazard.thf * ItemHazard.nugget, "nugget_thorium_fuel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_u233 = new ItemStack(new ItemHazard(ItemHazard.u233 * ItemHazard.nugget, "nugget_u233").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_u235 = new ItemStack(new ItemHazard(ItemHazard.u235 * ItemHazard.nugget, "nugget_u235").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_u238 = new ItemStack(new ItemHazard(ItemHazard.u238 * ItemHazard.nugget, "nugget_u238").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_u238m2 = new ItemStack(new ItemUnstable(60, 2000, "nugget_u238m2").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_unobtainium = new ItemStack(new ItemCustomLore("nugget_unobtainium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_unobtainium_greater = new ItemStack(new ItemHazard(1000, "nugget_unobtainium_greater").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_unobtainium_lesser = new ItemStack(new ItemCustomLore("nugget_unobtainium_lesser").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_uranium = new ItemStack(new ItemHazard(ItemHazard.u * ItemHazard.nugget, "nugget_uranium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_uranium_fuel = new ItemStack(new ItemHazard(ItemHazard.uf * ItemHazard.nugget, "nugget_uranium_fuel").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_verticium = new ItemStack(new ItemCustomLore("nugget_verticium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_weidanium = new ItemStack(new ItemCustomLore("nugget_weidanium").setCreativeTab(MainRegistry.partsTab));
	public static final ItemStack nugget_zirconium = new ItemStack(new ItemCustomLore("nugget_zirconium").setCreativeTab(MainRegistry.partsTab));
