...
public class GUICoreAdvanced extends GuiInfoContainer {
	...
	public GUICoreAdvanced(final InventoryPlayer invPlayer, final TileEntityCoreAdvanced tedf) {
	...
	public void drawScreen(final int mouseX, final int mouseY, final float f) {
		...
		final String[] text = new String[] { "Basically just a larger furnace with a queue and extreme speed.", "Use a factory cluster to keep the current speed." };
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft - 16, guiTop + 36, 16, 16, guiLeft - 8, guiTop + 36 + 16, text);
		
		final String[] text1 = new String[] { "Max production: 80/s at 16M HE/s and speed 400" };
	...
	protected void drawGuiContainerBackgroundLayer(final float p_146976_1_, final int p_146976_2_, final int p_146976_3_) {
		...
		if(diFurnace.progress > 0) {
			final int j = diFurnace.getProgressScaled(90);
