...
public class GUIMachineSatLinker extends GuiInfoContainer {
	...
	public GUIMachineSatLinker(final InventoryPlayer invPlayer, final TileEntityMachineSatLinker tedf) {
	...
	public void drawScreen(final int mouseX, final int mouseY, final float f) {
		...
		final String[] text = new String[] { "The first slot will copy the satellite/chip's",
				"frequency and paste it to the second slot." };
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft - 16, guiTop + 36, 16, 16, guiLeft - 8, guiTop + 36 + 16, text);
		
		final String[] text1 = new String[] { "The third slot will randomize the",
