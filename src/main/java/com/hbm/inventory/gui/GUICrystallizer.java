...
public class GUICrystallizer extends GuiInfoContainer {
	...
	public GUICrystallizer(final InventoryPlayer invPlayer, final TileEntityMachineCrystallizer acidomatic) {
	...
	protected void drawGuiContainerForegroundLayer(final int i, final int j) {
		final String name = this.acidomatic.hasCustomInventoryName() ? this.acidomatic.getInventoryName() : I18n.format(this.acidomatic.getInventoryName());
	...
	protected void drawGuiContainerBackgroundLayer(final float p_146976_1_, final int p_146976_2_, final int p_146976_3_) {
		...
		final int i = (int)acidomatic.getPowerScaled(52);
		drawTexturedModalRect(guiLeft + 152, guiTop + 70 - i, 176, 64 - i, 16, i);

		final int j = acidomatic.getProgressScaled(28);
