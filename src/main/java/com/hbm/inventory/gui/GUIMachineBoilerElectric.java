...
public class GUIMachineBoilerElectric extends GuiInfoContainer {
	...
	public GUIMachineBoilerElectric(final InventoryPlayer invPlayer, final TileEntityMachineBoilerElectric tedf) {
	...
	public void drawScreen(final int mouseX, final int mouseY, final float f) {
		...
		final String[] text = I18nUtil.resolveKeyArray("desc.guimachboilerel");
	...
	protected void drawGuiContainerBackgroundLayer(final float p_146976_1_, final int p_146976_2_, final int p_146976_3_) {
		...
		final int i = (int)dud.getPowerScaled(34);
