...
public class GUIMachineKeyForge extends GuiInfoContainer {
	...
	public GUIMachineKeyForge(final InventoryPlayer invPlayer, final TileEntityMachineKeyForge tedf) {
	...
	public void drawScreen(final int mouseX, final int mouseY, final float f) {
		...
		final String[] text = new String[] { "The first slot will copy the key/lock's",
