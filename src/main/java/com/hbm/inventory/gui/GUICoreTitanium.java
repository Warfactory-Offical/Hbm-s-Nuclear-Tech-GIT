...
public class GUICoreTitanium extends GuiInfoContainer {
	...
	public GUICoreTitanium(final InventoryPlayer invPlayer, final TileEntityCoreTitanium tedf) {
	...
	public void drawScreen(final int mouseX, final int mouseY, final float f) {
		...
		final String[] text = new String[] { "Basically just a larger furnace with a queue and more speed.", "Use a factory cluster to keep the current speed." };
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft - 16, guiTop + 36, 16, 16, guiLeft - 8, guiTop + 36 + 16, text);
		
		final String[] text1 = new String[] { "Max production: 10/s at 400k HE/s and speed 100" };
