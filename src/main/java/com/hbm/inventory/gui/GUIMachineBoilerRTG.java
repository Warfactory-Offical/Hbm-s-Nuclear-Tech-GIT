...
public class GUIMachineBoilerRTG extends GuiInfoContainer {
	...
	public GUIMachineBoilerRTG(final InventoryPlayer invPlayer, final TileEntityMachineBoilerRTG tedf) {
	...
	public void drawScreen(final int mouseX, final int mouseY, final float f) {
		...
		final String[] text = I18nUtil.resolveKeyArray("desc.guimachboilerrtg");
	...
	protected void drawGuiContainerForegroundLayer(final int i, final int j) {
		final String name = this.rtgBoiler.hasCustomInventoryName() ? this.rtgBoiler.getInventoryName() : I18n.format(this.rtgBoiler.getInventoryName());
