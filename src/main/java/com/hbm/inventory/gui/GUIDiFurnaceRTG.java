...
public class GUIDiFurnaceRTG extends GuiInfoContainer {
	...
	public GUIDiFurnaceRTG(final InventoryPlayer playerInv, final TileEntityDiFurnaceRTG te) {
	...
	public void drawScreen(final int mouseX, final int mouseY, final float f) {
		...
		final String[] descText = I18nUtil.resolveKeyArray("desc.gui.rtgBFurnace.desc", TileEntityDiFurnaceRTG.maxRTGPower);
	...
	protected void drawGuiContainerForegroundLayer(final int p_146979_1_, final int p_146979_2_) {
		final String name = I18n.format(bFurnace.getName());
	...
	protected void drawGuiContainerBackgroundLayer(final float p_146976_1_, final int p_146976_2_, final int p_146976_3_) {
		...
		if(bFurnace.isInvalid()) {
			final TileEntity te = bFurnace.getWorld().getTileEntity(bFurnace.getPos());
		...
		final int p = bFurnace.getDiFurnaceProgressScaled(24);
