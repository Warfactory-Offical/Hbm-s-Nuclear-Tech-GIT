...
"saturn",
	...
	public static final NTMMaterial MAT_DURA		= makeSmeltable("dura",       	DURA,			0x183039/*, 0x030B0B, 0x376373*/).setShapes(BOLT, INGOT, DUST, PIPE, BLOCK, LIGHTBARREL, HEAVYBARREL, LIGHTRECEIVER, HEAVYRECEIVER, GRIP).m();
