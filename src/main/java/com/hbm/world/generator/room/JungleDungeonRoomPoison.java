...
public class JungleDungeonRoomPoison extends JungleDungeonRoom {
	...
	public JungleDungeonRoomPoison(final CellularDungeon parent) {
		super(parent);
	}
			...
			public void work() {
				...
				final ITimedJob job = new ITimedJob() {
					...
					public void work() {
						...
						for(int i = 1; i < 4; i++) {
							final Block bl = world.getBlockState(new BlockPos(x, y + 2, z + i)).getBlock();
						...
						for(int i = 1; i < 4; i++) {
							final Block bl = world.getBlockState(new BlockPos(x + parent.width - 1, y + 2, z + i)).getBlock();
							if(bl == ModBlocks.brick_jungle || bl == ModBlocks.brick_jungle_cracked || bl == ModBlocks.brick_jungle_lava) {
						...
						for(int i = 1; i < 4; i++) {
							final Block bl = world.getBlockState(new BlockPos(x + i, y + 2, z)).getBlock();
							if(bl == ModBlocks.brick_jungle || bl == ModBlocks.brick_jungle_cracked || bl == ModBlocks.brick_jungle_lava) {
						...
						for(int i = 1; i < 4; i++) {
							final Block bl = world.getBlockState(new BlockPos(x + i, y + 2, z + parent.width - 1)).getBlock();
							if(bl == ModBlocks.brick_jungle || bl == ModBlocks.brick_jungle_cracked || bl == ModBlocks.brick_jungle_lava) {
