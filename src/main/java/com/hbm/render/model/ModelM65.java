...
public class ModelM65 extends ModelBiped {
	...
	public ModelM65() {
		...
		final ModelRenderer maskHead = new ModelRenderer(this, 0, 0);
		...
		final ModelRenderer nose = new ModelRenderer(this, 0, 16);
		...
		final ModelRenderer outlet = new ModelRenderer(this, 0, 20);
		...
		final ModelRenderer noseSlope = new ModelRenderer(this, 8, 16);
		...
		final ModelRenderer eye1 = new ModelRenderer(this, 0, 23);
		...
		final ModelRenderer eye2 = new ModelRenderer(this, 0, 26);
		...
		final ModelRenderer iForgot = new ModelRenderer(this, 6, 20);
		...
		final ModelRenderer filterConnector = new ModelRenderer(this, 6, 23);
		...
		final ModelRenderer filter1 = new ModelRenderer(this, 18, 21);
		...
		final ModelRenderer filter2 = new ModelRenderer(this, 18, 16);
	...
	@Override
	public void setRotationAngles(final float f2, final float f3, final float f4, final float f5, final float f6, final float f7, final Entity entity) {
