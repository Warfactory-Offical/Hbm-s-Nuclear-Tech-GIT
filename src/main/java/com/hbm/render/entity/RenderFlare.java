...
public  class  RenderFlare <E extends Entity> extends Render<E> {
	...
	protected RenderFlare(final RenderManager renderManager) {
		super(renderManager);
	}
	
	@Override
	public void doRender(final E entity, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(final E entity) {
		return null;
	}
