...
public class RenderMissileBurst extends Render<EntityMissileBurst> {
	...
	protected RenderMissileBurst(final RenderManager renderManager) {
		super(renderManager);
	}
	
	@Override
	public void doRender(final EntityMissileBurst missile, double x, double y, double z, final float entityYaw, final float partialTicks) {
		GL11.glPushMatrix();
	...
	@Override
	protected ResourceLocation getEntityTexture(final EntityMissileBurst entity) {
