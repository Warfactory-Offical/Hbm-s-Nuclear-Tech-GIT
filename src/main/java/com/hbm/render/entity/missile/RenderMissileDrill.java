...
public class RenderMissileDrill extends Render<EntityMissileDrill> {
	...
	protected RenderMissileDrill(final RenderManager renderManager) {
		super(renderManager);
	}
	
	@Override
	public void doRender(final EntityMissileDrill missile, double x, double y, double z, final float entityYaw, final float partialTicks) {
		GL11.glPushMatrix();
	...
	@Override
	protected ResourceLocation getEntityTexture(final EntityMissileDrill entity) {
