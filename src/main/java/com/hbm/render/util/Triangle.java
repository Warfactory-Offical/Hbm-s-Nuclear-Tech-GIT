...
public class Triangle {
	...
	public Triangle(final Vec3d p1, final Vec3d p2, final Vec3d p3) {
		this.p1 = new TexVertex(p1);
		this.p2 = new TexVertex(p2);
		this.p3 = new TexVertex(p3);
	}
	
	public Triangle(final Vec3d p1, final Vec3d p2, final Vec3d p3, final float[] texCoords) {
	...
	public void tessellateAll(final BufferBuilder buf){
	...
	public static class TexVertex {
		...
		public TexVertex(final Vec3d pos) {
			this.pos = pos;
			texX = 0;
			texY = 0;
		}
		
		public TexVertex(final Vec3d pos, final float x, final float y) {
			this.pos = pos;
			texX = x;
			texY = y;
		}
