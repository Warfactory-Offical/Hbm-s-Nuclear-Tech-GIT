...
public class RenderAccessoryUtility {
	...
	public static ResourceLocation getCloakFromPlayer(final EntityPlayer player) {
	...
	public static void loadCape(final NetworkPlayerInfo info, final ResourceLocation rl) {
		try {
			@SuppressWarnings("deprecation") final Map<Type, ResourceLocation> playerTextures = ReflectionHelper.getPrivateValue(NetworkPlayerInfo.class, info, "playerTextures", "field_187107_a");
