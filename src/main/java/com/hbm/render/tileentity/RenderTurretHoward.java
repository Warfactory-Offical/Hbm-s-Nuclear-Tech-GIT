...
public class RenderTurretHoward extends RenderTurretBase<TileEntityTurretHoward> {
	...
	@Override
	public void render(final TileEntityTurretHoward turret, final double x, final double y, final double z, final float partialTicks, final int destroyStage, final float alpha){
