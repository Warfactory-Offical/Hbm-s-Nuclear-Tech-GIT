...
public class RenderAMSLimiter extends TileEntitySpecialRenderer<TileEntityAMSLimiter> {
	...
	@Override
	public boolean isGlobalRenderer(final TileEntityAMSLimiter te) {
		return true;
	}
	
	@Override
	public void render(final TileEntityAMSLimiter te, final double x, final double y, final double z, final float partialTicks, final int destroyStage, final float alpha) {
		GL11.glPushMatrix();
	...
	public void renderTileEntityAt2(final TileEntity tileEntity, final double x, final double y, final double z, final float f)
    {
       ...
       // bindTexture(ResourceManager.universal);
        ...
        final TileEntityAMSLimiter limiter = (TileEntityAMSLimiter)tileEntity;
