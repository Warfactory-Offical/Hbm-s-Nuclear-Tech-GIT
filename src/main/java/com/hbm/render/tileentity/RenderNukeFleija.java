...
public class RenderNukeFleija extends TileEntitySpecialRenderer<TileEntityNukeFleija> {
    ...
    @Override
    public void render(final TileEntityNukeFleija te, final double x, final double y, final double z, final float partialTicks, final int destroyStage, final float alpha) {
    	GL11.glPushMatrix();
