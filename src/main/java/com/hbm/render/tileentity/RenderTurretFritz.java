...
public class RenderTurretFritz extends RenderTurretBase<TileEntityTurretFritz> {
	...
	@Override
	public void render(final TileEntityTurretFritz turret, final double x, final double y, final double z, final float partialTicks, final int destroyStage, final float alpha){
