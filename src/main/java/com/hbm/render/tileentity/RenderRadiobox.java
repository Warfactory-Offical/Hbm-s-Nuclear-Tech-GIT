...
public class RenderRadiobox extends TileEntitySpecialRenderer<TileEntityRadiobox> {
	...
	@Override
	public void render(final TileEntityRadiobox te, final double x, final double y, final double z, final float partialTicks, final int destroyStage, final float alpha) {
		GL11.glPushMatrix();
