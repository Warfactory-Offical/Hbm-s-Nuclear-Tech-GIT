...
public class EntityOilSpillFX extends EntityModFX {
    ...
    public EntityOilSpillFX(final World world) {
    	super(world, 0, 0, 0);
    }

    public EntityOilSpillFX(final World p_i1225_1_, final double p_i1225_2_, final double p_i1225_4_, final double p_i1225_6_, final double p_i1225_8_, final double p_i1225_10_, final double p_i1225_12_)
    {
        this(p_i1225_1_, p_i1225_2_, p_i1225_4_, p_i1225_6_, p_i1225_8_, p_i1225_10_, p_i1225_12_, 1.0F);
    }

    public EntityOilSpillFX(final World p_i1226_1_, final double p_i1226_2_, final double p_i1226_4_, final double p_i1226_6_, final double p_i1226_8_, final double p_i1226_10_, final double p_i1226_12_, final float p_i1226_14_)
    {
