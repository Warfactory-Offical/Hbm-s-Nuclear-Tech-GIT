...
public class EntityDischarge extends Entity implements IProjectile {
    ...
    public EntityDischarge(final World p_i1753_1_)
    {
        super(p_i1753_1_);
    ...
    public EntityDischarge(final World p_i1754_1_, final double p_i1754_2_, final double p_i1754_4_, final double p_i1754_6_)
    {
        super(p_i1754_1_);
    ...
    public EntityDischarge(final World p_i1755_1_, final EntityLivingBase p_i1755_2_, final EntityLivingBase p_i1755_3_, final float p_i1755_4_, final float p_i1755_5_)
    {
        super(p_i1755_1_);
    ...
    public EntityDischarge(final World p_i1756_1_, final EntityLivingBase p_i1756_2_, final float p_i1756_3_, final EnumHand hand)
    {
        super(p_i1756_1_);
    ...
    public EntityDischarge(final World world, final int x, final int y, final int z, final double mx, final double my, final double mz, final double grav) {
        super(world);
    	this.posX = x + 0.5F;
    	this.posY = y + 0.5F;
    	this.posZ = z + 0.5F;
	...
	public void onUpdate()
    {
        ...
        if (this.inGround)
        {
    		...
    		final EntityEMPBlast cloud = new EntityEMPBlast(this.world, 10);
	...
	public void onCollideWithPlayer(final EntityPlayer p_70100_1_)
    {
        if (!this.world.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !p_70100_1_.inventory.addItemStackToInventory(ItemStackUtil.itemStackFrom(ModItems.gun_rpg_ammo, 1)))
            {
                flag = false;
            }
