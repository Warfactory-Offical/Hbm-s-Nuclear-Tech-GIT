...
public class EntityLN2 extends Entity implements IProjectile {
    ...
    public EntityLN2(final World p_i1753_1_)
    {
        super(p_i1753_1_);
    ...
    public EntityLN2(final World p_i1754_1_, final double p_i1754_2_, final double p_i1754_4_, final double p_i1754_6_)
    {
        super(p_i1754_1_);
    ...
    public EntityLN2(final World p_i1755_1_, final EntityLivingBase p_i1755_2_, final EntityLivingBase p_i1755_3_, final float p_i1755_4_, final float p_i1755_5_)
    {
        super(p_i1755_1_);
    ...
    public EntityLN2(final World p_i1756_1_, final EntityLivingBase p_i1756_2_, final float p_i1756_3_, final EnumHand hand)
    {
        super(p_i1756_1_);
    ...
    public EntityLN2(final World world, final int x, final int y, final int z, final double mx, final double my, final double mz, final double grav) {
        super(world);
    	this.posX = x + 0.5F;
    	this.posY = y + 0.5F;
    	this.posZ = z + 0.5F;
	...
	public void onUpdate()
    {
        ...
        {
            final AxisAlignedBB axisalignedbb = blockstate.getCollisionBoundingBox(world, pos);
