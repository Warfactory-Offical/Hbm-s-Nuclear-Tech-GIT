...
public class EntityMissileMirv extends EntityMissileBaseAdvanced {
	...
	public EntityMissileMirv(final World p_i1582_1_) {
		super(p_i1582_1_);
		this.setSize(1F, 11F);
	}

	public EntityMissileMirv(final World world, final float x, final float y, final float z, final int a, final int b) {
	...
	public List<ItemStack> getDebris() {
		...
		list.add(ItemStackUtil.itemStackFrom(ModItems.circuit_targeting_tier5, 1));
	...
	public ItemStack getDebrisRareDrop() {
		return ItemStackUtil.itemStackFrom(ModItems.warhead_mirv);
	}
