...
public class EntityMissileBurst extends EntityMissileBaseAdvanced {
	...
	public EntityMissileBurst(final World p_i1582_1_) {
		super(p_i1582_1_);
		this.setSize(2F, 18F);
	}

	public EntityMissileBurst(final World world, final float x, final float y, final float z, final int a, final int b) {
