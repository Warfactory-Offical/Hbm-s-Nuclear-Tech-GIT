...
public class ParticleHeatDistortion extends Particle {
	...
	public ParticleHeatDistortion(final World worldIn, final double posXIn, final double posYIn, final double posZIn, final float scale, final float heatAmount, final int lifetime, final float timeOffset) {
	...
	public ParticleHeatDistortion motion(final float mX, final float mY, final float mZ){
		this.motionX = mX;
		this.motionY = mY;
		this.motionZ = mZ;
		return this;
