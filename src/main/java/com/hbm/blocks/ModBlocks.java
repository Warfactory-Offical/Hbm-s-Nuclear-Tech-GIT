...
public class ModBlocks {
	...
	public static final Block machine_chemp1lant = new MachineChemplant(Material.IRON, "machine_chemplant").setHardness(5.0F).setResistance(100.0F).setCreativeTab(MainRegistry.machineTab);
