...
public class DummyBlockAMSLimiter extends BlockContainer implements IDummy {
	...
	public DummyBlockAMSLimiter(final Material materialIn, final String s) {
		super(materialIn);
	...
	public boolean onBlockActivated(final World world, final BlockPos pos, final IBlockState state, final EntityPlayer player, final EnumHand hand, final EnumFacing facing, final float hitX, final float hitY, final float hitZ) {
		...
		} else if(!player.isSneaking())
		{
    		...
    		if(te != null && te instanceof TileEntityDummy) {
    			...
    			final TileEntityAMSLimiter entity = (TileEntityAMSLimiter) world.getTileEntity(a);
    			if(entity != null)
    			{
	...
	public ItemStack getPickBlock(final IBlockState state, final RayTraceResult target, final World world, final BlockPos pos, final EntityPlayer player) {
		return ItemStackUtil.itemStackFrom(ModBlocks.ams_limiter);
	}
