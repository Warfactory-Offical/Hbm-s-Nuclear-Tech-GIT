...
public class MachineSatLinker extends BlockContainer {
	...
	public MachineSatLinker(final Material materialIn, final String s) {
		super(materialIn);
	...
	public boolean onBlockActivated(final World world, final BlockPos pos, final IBlockState state, final EntityPlayer player, final EnumHand hand, final EnumFacing facing, final float hitX, final float hitY, final float hitZ) {
		...
		{
			final TileEntityMachineSatLinker entity = (TileEntityMachineSatLinker) world.getTileEntity(pos);
			if(entity != null)
			{
