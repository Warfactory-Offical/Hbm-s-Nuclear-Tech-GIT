...
public class DummyBlockTurbofan extends DummyOldBase {
	...
	public DummyBlockTurbofan(final Material materialIn, final String s, final boolean port) {
    ...
    public boolean onBlockActivated(final World world, final BlockPos pos, final IBlockState state, final EntityPlayer player, final EnumHand hand, final EnumFacing facing, final float hitX, final float hitY, final float hitZ) {
		...
		} else if(!player.isSneaking())
		{
    		...
    		if(te != null && te instanceof TileEntityDummy) {
    			...
    			final TileEntityMachineTurbofan entity = (TileEntityMachineTurbofan) world.getTileEntity(a);
    			if(entity != null)
    			{
