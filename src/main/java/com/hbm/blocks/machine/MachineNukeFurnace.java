...
public class MachineNukeFurnace extends BlockContainer {
	...
	public MachineNukeFurnace(final boolean active, final String s) {
		super(Material.IRON);
	...
	public ItemStack getPickBlock(final IBlockState state, final RayTraceResult target, final World world, final BlockPos pos, final EntityPlayer player) {
		return ItemStackUtil.itemStackFrom(ModBlocks.machine_nuke_furnace_off);
	}
	...
	public boolean onBlockActivated(final World world, final BlockPos pos, final IBlockState state, final EntityPlayer player, final EnumHand hand, final EnumFacing facing, final float hitX, final float hitY, final float hitZ) {
		...
		{
			final TileEntityNukeFurnace entity = (TileEntityNukeFurnace) world.getTileEntity(pos);
			if(entity != null)
			{
