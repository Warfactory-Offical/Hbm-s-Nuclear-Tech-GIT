...
public class MachineElectricFurnace extends BlockContainer {
	...
	public MachineElectricFurnace(final Material materialIn, final boolean active, final String s) {
		super(materialIn);
	...
	public boolean onBlockActivated(final World world, final BlockPos pos, final IBlockState state, final EntityPlayer player, final EnumHand hand, final EnumFacing facing, final float hitX, final float hitY, final float hitZ) {
		...
		{
			final TileEntityMachineElectricFurnace entity = (TileEntityMachineElectricFurnace) world.getTileEntity(pos);
			if(entity != null)
			{
